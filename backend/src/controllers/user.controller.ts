...
export class UserController{
    login=(req: express.Request,res: express.Response)=>{
        ...
        User.findOne({'username':username,'password':password,'valid':true},(err,user)=>{
            if(err){
                console.log(err);
            }else{
    ...
    getUsers=(req: express.Request,res:express.Response)=>{
        User.find({'valid':true,'type':{$ne:'admin'}},(err,users)=>{
            if(err){
                console.log(err);
            }else{           
                res.status(200).json(users);
    ...
    acceptRegistration=(req: express.Request,res:express.Response)=>{
        let username=req.body.username;
        ...
        User.findOneAndUpdate({'username': username},{'valid':true},(err)=>{
            if(err){
                console.log(err);
            }else{
                res.status(200).json({'message': 'ok'});
    ...
    updateUser=(req: express.Request,res:express.Response)=>{
        ...
        console.log(req.body);
        User.findOneAndUpdate({'username': username},update,(err: any)=>{
            if(err){
                console.log(err);
            }else{
                console.log("UPDEJT!");
    ...
    changePassword=(req: express.Request,res:express.Response)=>{
        ...
        console.log(req.body);
        User.findOneAndUpdate({'username': username,"password": password},update,(err: any)=>{
            if(err){
                console.log(err);
            }else{
                console.log("UPDEJT!");
    ...
    updateAdvertiserAgency=(req: express.Request,res:express.Response)=>{
        let username=req.body.username;
